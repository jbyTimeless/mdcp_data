...
class DatasetCreateReq(BaseModel):
    ...
    related_dataset_id: Optional[str] = Field(None, description="关联数据集ID")
    stat_level1_id: Optional[str] = Field(None, description="关联统计树一级分类ID")
    stat_level2_id: Optional[str] = Field(None, description="关联统计树二级分类ID")
    stat_level3_id: Optional[str] = Field(None, description="关联统计树三级分类ID")
...
class DatasetOverviewUpdateReq(BaseModel):
    dataset_id: str = Field(..., description="数据集业务ID")
